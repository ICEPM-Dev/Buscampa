    ...
    <div className="space-y-6">
      <div className="bg-red-50 border border-red-200 rounded-xl p-6">
        <div className="flex items-start gap-3 mb-4">
          ...
          <div>
            <h3 className="font-semibold text-red-900 mb-2">Eliminación de cuenta</h3>
            <p className="text-sm text-red-700">
              Esta acción es <span className="font-semibold">irreversible</span>. Todos tus datos serán eliminados permanentemente, incluyendo:
            </p>
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-slate-600">
              Para eliminar tu cuenta, debes confirmar tu identidad ingresando tu contraseña
            </p>
          </div>
        </div>
